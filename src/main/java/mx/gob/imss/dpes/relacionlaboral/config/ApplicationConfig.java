package mx.gob.imss.dpes.relacionlaboral.config;
...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(mx.gob.imss.dpes.relacionlaboral.endPoint.RelacionLaboralEndPoint.class);
        resources.add(mx.gob.imss.dpes.relacionlaboral.service.RelacionLaboralService.class);
